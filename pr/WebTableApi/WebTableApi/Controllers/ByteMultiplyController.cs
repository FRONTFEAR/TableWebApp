...
{
    /// <summary>
    /// Этот контроллер позволяет умножать байты добавляя результат в  базу данных
    /// </summary>
    [Route("api/[controller]")]
    [ApiController]
    public class ByteMultiplyController:ControllerBase
    {
        private readonly IConfiguration _configuration;
        public ByteMultiplyController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        /// <summary>
        /// Этот метод выполняет умножение и добавляет результат в базу данных
        /// </summary>
        [HttpPost]
